...
💡 Уникальность UM - это широкий выбор увлечений. Не нашёл свое? Добавь его через хэштеги!	
	`
...
1. Заполни анкету, выбрав свои увлечения: Укажи свои интересы с помощью хэштегов (например, #кино, #путешествия, #музыка). 
2. Просмотри свой профиль: После заполнения анкеты ты сможешь посмотреть свой профиль и увидеть выбранные тобой хэштеги.
3. Получи рекомендации: Мы будем подбирать тебе других пользователей с похожими интересами. Чем больше совпадений по хэштегам, тем выше шанс встретить своего идеального собеседника! 
...
`
	...
	msgText = `
	❤️Не упустите возможность найти друзей и единомышленников в мире интересов! Мы уверены, что Um-бот поможет вам создать незабываемые связи. Удачи и приятного общения!💬✨
	`
